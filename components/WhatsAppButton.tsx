// Site-wide floating WhatsApp button. This is a plain anchor (no client JS),
// so it renders on the server, works without hydration, and adds nothing to the
// JS bundle — important given the perf budget on this site. Sits at the TOP of
// the bottom-right FAB stack, above the meeting (bottom-24) and chat (bottom-6)
// buttons.
...
export default function WhatsAppButton() {
  return (
    <a
      ...
      className="group fixed bottom-[10.5rem] right-6 z-50 flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-[0_6px_20px_rgba(37,211,102,0.45)] transition-transform duration-300 hover:scale-105 active:scale-95"
    >
