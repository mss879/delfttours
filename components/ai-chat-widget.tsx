    ...
    return (
        <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end gap-4 font-sans">
            ...
            <AnimatePresence>
                {isOpen && (
                    <motion.div
                        ...
                        className="flex h-[500px] w-[350px] flex-col overflow-hidden rounded-2xl border border-gray-200 bg-white shadow-2xl sm:w-[400px]"
                    >
                        {/* Header */}
            ...
            <div className="relative group">
                {!isOpen && (
                    <>
                        <span className="absolute inset-0 h-full w-full animate-ping rounded-full bg-sky-400 opacity-75"></span>
                        <span className="absolute inset-0 h-full w-full rounded-full bg-sky-500 opacity-20 animate-pulse"></span>
                    </>
                )}
                <motion.button
                    ...
                    whileTap={{ scale: 0.95 }}
                    className="relative flex h-14 w-14 items-center justify-center rounded-full bg-[#0b3e63] text-white shadow-lg transition-colors hover:bg-[#093554] focus:outline-none focus:ring-4 focus:ring-[#0b3e63]/20"
                >
                    {isOpen ? (
                        <X className="h-6 w-6" />
                    ) : (
