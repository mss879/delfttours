            ...
            <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto sm:max-h-[85vh]">
                <DialogHeader>
                    <DialogTitle className="text-2xl font-bold text-[#0b3e63]">
                        {isSuccess ? 'Request Received!' : 'Plan Your Dream Trip'}
                    </DialogTitle>
                    <DialogDescription>
                        {isSuccess
                            ? 'Thank you for contacting us. Our travel experts will be in touch shortly.'
                ...
                {isSuccess ? (
                    <div className="flex flex-col items-center justify-center py-12 space-y-4">
                        ...
                        <Button onClick={() => setIsOpen(false)} className="bg-[#0b3e63]">
                            Close
                        </Button>
                    </div>
                ) : (
